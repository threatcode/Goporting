...
import (
	"fmt"
	"github.com/ThreatCode/Goporting/internal/cli/dispatcher"
	"github.com/ThreatCode/Goporting/internal/context"
	"github.com/ThreatCode/Goporting/internal/context/Conf"
	"github.com/ThreatCode/Goporting/internal/context/Models"
	"github.com/ThreatCode/Goporting/internal/util/assets"
	"github.com/ThreatCode/Goporting/internal/util/config"
	"github.com/ThreatCode/Goporting/internal/util/fs"
	"github.com/ThreatCode/Goporting/internal/util/log"
	"github.com/ThreatCode/Goporting/internal/util/update"
...
func main() {
	...
	// Display goporting information
	log.Success("Goporting %s is starting...", update.Version)
